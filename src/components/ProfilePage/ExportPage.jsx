...
export const handleDownloadAsPpt = ({
	...
	personalDetailSlide.addText('Personal Details', {
		x: 1,
		y: 1,
		fontSize: 20,
		bold: true,
	...
	assetsDetailSlide.addText('Assets Details', {
		x: 1,
		y: 1,
		fontSize: 20,
		bold: true,
	...
	existingProvisionsSlide.addText('Existing provisions Details', {
		x: 1,
		y: 1,
		fontSize: 20,
		bold: true,
	...
	existingProvisionsSlide.addText(existingProvisionsText, {
		x: 1,
		y: 0,
		w: 9,
		h: 9,
	...
	expensesDetailSlide.addText('Expenses Details', {
		x: 1,
		y: 1,
		fontSize: 20,
		bold: true,
	...
	goalsSlide.addText('Goals Details', {
		x: 1,
		y: 1,
		fontSize: 20,
		bold: true,
	...
	incomeDetailSlide.addText('Income Details', {
		x: 1,
		y: 1,
		fontSize: 20,
		bold: true,
	...
	liabilityDetailSlide.addText('Liability Details', {
		x: 1,
		y: 1,
		fontSize: 20,
		bold: true,
	...
	existingPoliciesSlide.addText('Existing Policies', {
		x: 1,
		y: 1,
		fontSize: 20,
		bold: true,
	...
	existingPoliciesSlide.addText(existingPoliciesText, {
		x: 1,
		y: 0,
		w: 9,
		h: 9,
...
export const handleDownloadAsPdf = () => {
			...
			>
				...
				>
					...
					<InputField
						...
						onChange={(maritalStatus) =>
							handleChange('personalDetail', 'maritalStatus', maritalStatus)
						}
					/>
					<Box
						width={'100%'}
					...
					>
						...
						>
							...
							<PhoneInput
								...
								onChange={(phone) =>
									handleChange('personalDetail', 'phoneNumber', phone)
								}
						...
						<InputField
							...
							onChange={(email) =>
								handleChange('personalDetail', 'email', email)
							}
						/>
						<InputField
						...
						>
							...
							>
								...
								<RadioGroup
									...
									onChange={(event) =>
										handleChange('personalDetail', 'smoker', event.target.value)
									}
								>
									<FormGroup row>
										<FormControlLabel
						...
						<InputField
							...
							onChange={(medicalHistory) =>
								handleChange('personalDetail', 'medicalHistory', medicalHistory)
							}
						/>
					</Box>
				</Box>
				...
				>
					...
					>
						...
						<InputField
							...
							onChange={(propertyIncome) =>
								handleChange('incomeDetail', 'propertyIncome', propertyIncome)
							}
						/>
						<InputField
							label={'Bank Returns'}
							...
							onChange={(bankReturns) =>
								handleChange('incomeDetail', 'bankReturns', bankReturns)
							}
						/>
					</Box>
					<Typography
					...
					>
						<InputField
							...
							onChange={(salary) =>
								handleChange('incomeDetail', 'salary', salary)
							}
						/>
						<InputField
							label={'Total Income'}
							...
							onChange={(totalIncome) =>
								handleChange('incomeDetail', 'totalIncome', totalIncome)
							}
						/>
						<InputField
							label={'Bonus'}
					...
					>
						<InputField
							...
							onChange={(utilityBill) =>
								handleChange('expensesDetail', 'utilityBill', utilityBill)
							}
						/>
						<InputField
							label={'Rent'}
					...
					>
						...
						<InputField
							...
							onChange={(leisureExpense) =>
								handleChange('expensesDetail', 'leisureExpense', leisureExpense)
							}
						/>
						<InputField
						...
						<InputField
							...
							onChange={(medicalExpense) =>
								handleChange('expensesDetail', 'medicalExpense', medicalExpense)
							}
						/>
					</Box>
				</Box>
					...
					>
						...
						<InputField
							...
							onChange={(propertyValue) =>
								handleChange('assetsDetail', 'propertyValue', propertyValue)
							}
						/>
						<InputField
							...
							onChange={(shares) =>
								handleChange('assetsDetail', 'shares', shares)
							}
						/>
						<InputField
							...
							onChange={(businessAssets) =>
								handleChange('assetsDetail', 'businessAssets', businessAssets)
							}
						/>
						<InputField
							label={'Others'}
							...
							onChange={(others) =>
								handleChange('assetsDetail', 'others', others)
							}
						/>
						<InputField
							label={'Total Assets'}
							...
							onChange={(totalAssets) =>
								handleChange('assetsDetail', 'totalAssets', totalAssets)
							}
						/>
					</Box>
				</Box>
				...
				>
					<InputField
						...
						onChange={(bankLoans) =>
							handleChange('liabilityDetail', 'bankLoans', bankLoans)
						}
					/>
					<InputField
						...
						onChange={(creditCard) =>
							handleChange('liabilityDetail', 'creditCard', creditCard)
						}
					/>
					<InputField
						label={'Mortgages'}
						...
						onChange={(mortgages) =>
							handleChange('liabilityDetail', 'mortgages', mortgages)
						}
					/>
					<InputField
						label={'Auto Loans'}
						...
						onChange={(autoLoans) =>
							handleChange('liabilityDetail', 'autoLoans', autoLoans)
						}
					/>
					<InputField
						label={'Hand Loans'}
						...
						onChange={(handLoans) =>
							handleChange('liabilityDetail', 'handLoans', handLoans)
						}
					/>
					<InputField
				...
				>
					<InputField
						...
						onChange={(childrenEducation) =>
							handleChange('goals', 'childrenEducation', childrenEducation)
						}
					/>
					<InputField
						...
						onChange={(universityCapital) =>
							handleChange('goals', 'universityCapital', universityCapital)
						}
					/>
					<InputField
						...
						onChange={(universityYearsLeft) =>
							handleChange('goals', 'universityYearsLeft', universityYearsLeft)
						}
					/>
					<InputField
					...
					<InputField
						...
						onChange={(retirementIncome) =>
							handleChange('goals', 'retirementIncome', retirementIncome)
						}
					/>
					<InputField
						...
						onChange={(incomeIncaseOfDeath) =>
							handleChange('goals', 'incomeIncaseOfDeath', incomeIncaseOfDeath)
						}
					/>
					<InputField
				...
				>
					...
					<InputField
						...
						onChange={(lifeInsurance) =>
							handleChange('existingProvisions', 'lifeInsurance', lifeInsurance)
						}
					/>
					<InputField
						label={'Disability'}
						...
						onChange={(disability) =>
							handleChange('existingProvisions', 'disability', disability)
						}
					/>
					<InputField
						label={'Retirement'}
						...
						onChange={(retirement) =>
							handleChange('existingProvisions', 'retirement', retirement)
						}
					/>
					<InputField
				...
				>
					...
					>
						...
						<InputField
							...
							onChange={(value) =>
								handleChange('existingPolicies', 'lifeInsurance.term', value)
							}
						/>
						<InputField
							label={'Benefits'}
					...
					>
						<InputField
							...
							onChange={(value) =>
								handleChange('existingPolicies', 'retirement.policyNo', value)
							}
						/>
						<InputField
							label={'Annual Premium'}
						...
						<InputField
							...
							onChange={(value) =>
								handleChange('existingPolicies', 'retirement.term', value)
							}
						/>
						<InputField
							label={'Benefits'}
							...
							onChange={(value) =>
								handleChange('existingPolicies', 'retirement.benefits', value)
							}
						/>
					</Box>
				</Box>
