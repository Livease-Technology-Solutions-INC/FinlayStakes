...
const IncomeDetail=({ onNext, onPrev })=> {
  ...
  return (
    <Box width="100%" display={'flex'} flexDirection={"column"} gap={"32px"} >
      ...
      <Typography sx={{ color:"#212844",fontWeight:"600px",fontSize:"20px",fontFamily: 'Inter, sans-serif' , lineHeight:"24.2px"}}>Saving Details</Typography>
        ...
        <Typography sx={{color:"#212844", fontWeight:"600px", fontSize:"20px",fontFamily: 'Inter, sans-serif' }}>Non Saving Details</Typography>
